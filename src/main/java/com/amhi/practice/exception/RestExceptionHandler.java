package com.amhi.practice.exception;


import com.amhi.practice.error.RestError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
            ...
            HttpStatus status,
            WebRequest request) {
        RestError apiError = new RestError(BAD_REQUEST);
    ...
    protected ResponseEntity<Object> handleEntityNotFound(
        ...
        RestError apiError = new RestError(NOT_FOUND);
    ...
    protected ResponseEntity<Object> handleNoSuchElementException(NoSuchElementException ex,
                                                                      WebRequest request) {
        RestError apiError = new RestError(INTERNAL_SERVER_ERROR);
        apiError.setMessage(ex.getMessage());
    ...
    protected ResponseEntity<Object> handleNullPointerException(NullPointerException ex) {
        String error = ex.getStackTrace()[0].getFileName();
        String[] arrOfStr = error.split("\\.");
        String fileName=arrOfStr[0].toString();
        String methodName= ex.getStackTrace()[0].getMethodName();
        int lineNumber=ex.getStackTrace()[0].getLineNumber();;
        RestError apiError = new RestError(INTERNAL_SERVER_ERROR);
        apiError.setMessage(String.format("Null pointer exception in class '%s', method  '%s' and line number '%s'",fileName,methodName,lineNumber));
        apiError.setDebugMessage(ex.getStackTrace().toString());
        return buildResponseEntity(apiError);
    }
